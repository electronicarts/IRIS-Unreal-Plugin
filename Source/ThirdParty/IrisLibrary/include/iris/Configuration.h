...
namespace iris
{
	...
	public:
		...
		enum class LuminanceType {LT_UN_SET = 0, LT_CD, LT_RELATIVE};

		inline void SetLuminanceType(LuminanceType luminance) { m_luminanceType = luminance; }
		inline void SetLuminanceType(const std::string& luminance) { m_luminanceType = luminance == "CD" ?LuminanceType::LT_CD : LuminanceType::LT_RELATIVE; }
	...
	private:
		...
		LuminanceType m_luminanceType = LuminanceType::LT_UN_SET;
