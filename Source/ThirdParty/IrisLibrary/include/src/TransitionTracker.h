...
namespace iris
{
	...
	public:
		...
		TransitionTracker(unsigned int fps, TransitionTrackerParams* params);
	...
	protected:
		...
		float m_oneSecTimeBarrier;
		int m_oneSecTimeStampsIndex;

		float m_fourSecTimeBarrier;
		int m_fourSecTimeStampsIndex;

		float m_fiveSecTimeBarrier;
		int m_fiveSecTimeStampsIndex;
	};
